      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav mx-auto">
            <li class="nav-item">
              <a href="#intro" class="nav-link smoothScroll">Profile</a>
            </li>
            <li class="nav-item">
      ...
      <div class="container">
        <div class="row">
                <div class="mx-auto col-lg-5 col-md-5 col-10 ">
                  <img src="images/ban.png" class="img-fluid" alt="Ben Resume HTML Template">
                </div>

                <div class="d-flex flex-column justify-content-center align-items-center col-lg-7 col-md-7 col-12">
                  <div class="hero-text">
                    <h1>Profile</h1>
                    <p>Experienced Web Developer adept in all stages of advanced web development. Knowledgeable in user interface, testing, and debugging processes. Bringing forth expertise in design, installation, testing and maintenance of web systems. Equipped with a diverse and promising skill-set. Able to effectively self-manage during independent projects, as well as collaborate in a team setting.</p>
                    <a href="images/waiphyo.pdf" class="custom-btn btn" target="_blank">resume</a>
                  </div>
                </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <h2 class="mb-4">About Wai Phyo</h2>
                    <ul class="mt-4 mb-5 mb-lg-0 profile-list list-unstyled">
                        ...
                        <li><strong>GitHub :</strong><a href="https://waiphyo22.github.io/portfolio.io/"> https://waiphyo22.github.io/portfolio.io/</a></li>

                        <li><strong>Email :</strong> waiphyo055192@gmail.com</li>
                </div>

                <div class="col-lg-5 mx-auto col-md-6 col-12">
                    <img src="images/agency.jpg" class="about-image img-fluid" alt="Ben's Resume HTML Template">
                </div>
    ...
    <section id="contact">
      <div class="container">
        <div class="row justify-content-center">
              ...
              <li><a href="https://www.facebook.com/way.phyo.353/" rel="noopener" class="fab fa-facebook"></a></li>
              <li><a href="#" rel="noopener" class="fab fa-instagram"></a></li>
              <li><a href="https://www.linkedin.com/in/wai-phyo-10512b280/" rel="noopener" class="fab fa-linkedin"></a></li>
              <li><a href="https://www.youtube.com/@waiphyoyaw5924" rel="noopener" class="fab fa-youtube"></a></li>
          </ul>
        </div>
      </div>
    </section>
